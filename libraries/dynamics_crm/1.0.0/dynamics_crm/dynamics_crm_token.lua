-- ---------------------------------------------------------------------------
-- dynamics_crm_token - access token cache
--
-- Dynamics 365 access tokens are cached in memory. A Source Custom node keeps
...
-- Keyed by "<username>@<url>" so a node configured against more than one
-- Dynamics environment cannot hand the wrong token to the wrong endpoint.
local Cache = {}
